...
sort -n -t ',' -k2 -k3 -u ./paymo_input/batch_payment.txt > ./paymo_input/batch_payment_unique.txt

python ./src/antifraud.py ./paymo_input/batch_payment_unique.txt ./paymo_input/stream_payment.txt ./paymo_output/output1.txt ./paymo_output/output2.txt ./paymo_output/output3.txt
